  ...
  _createClass(Block, null, [
    ...
    },
    {
      ...
      value: function mineBlock(_ref4) {
        ...
        return new this({
          blockHeaders: _objectSpread(
            _objectSpread({}, truncatedBlockHeaders),
            {},
            {
              nonce: nonce,
            }
    ...
    },
    {
      ...
      value: function validateBlock(_ref5) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          if (
            (0, _index.keccakHash)(block) ===
            (0, _index.keccakHash)(Block.genesis())
          ) {
            return resolve();
          }
          if (
            (0, _index.keccakHash)(lastBlock.blockHeaders) !==
