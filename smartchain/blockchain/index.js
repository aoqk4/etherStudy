...
var validateBlock = _block["default"].validateBlock;
var BlockChain = /*#__PURE__*/function () {
  ...
  _createClass(BlockChain, [{
    ...
    value: function addBlock(_ref) {
      ...
      return new Promise(function (resolve, reject) {
        validateBlock({
          ...
          transactionQueue.clearBlockTransaction({
    ...
    key: "replaceChain",
    value: function replaceChain(_ref2) {
      var _this2 = this;
      var chain = _ref2.chain;
      return new Promise( /*#__PURE__*/function () {
        var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
          var i, block, lastBlockIndex, lastBlock;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 1:
                ...
                block = chain[i];
                lastBlockIndex = i - 1;
                lastBlock = lastBlockIndex >= 0 ? chain[i - 1] : null; // 비동기 방식으로 이루어지기 때문에 실시간으로 체인을 검사 X
              ...
              case 13:
                console.log("* -- Validated block number : ".concat(block.blockHeaders.number));
              case 14:
                i++;
                _context.next = 1;
                break;
...
var _default = BlockChain; // 블록 생성 해보는 Debug Code
